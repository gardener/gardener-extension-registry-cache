...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*registry.GarbageCollection)(nil), (*GarbageCollection)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*GarbageCollection)(nil), (*registry.GarbageCollection)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha2_RegistryCache_To_registry_RegistryCache(in *RegistryCache, out *registry.RegistryCache, s conversion.Scope) error {
	...
	if in.GarbageCollection != nil {
		...
		*out = new(registry.GarbageCollection)
		if err := Convert_v1alpha2_GarbageCollection_To_registry_GarbageCollection(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_registry_RegistryCache_To_v1alpha2_RegistryCache(in *registry.RegistryCache, out *RegistryCache, s conversion.Scope) error {
	...
	if in.GarbageCollection != nil {
		...
		*out = new(GarbageCollection)
		if err := Convert_registry_GarbageCollection_To_v1alpha2_GarbageCollection(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.GarbageCollection = nil
...
func autoConvert_v1alpha2_RegistryConfig_To_registry_RegistryConfig(in *RegistryConfig, out *registry.RegistryConfig, s conversion.Scope) error {
	if in.Caches != nil {
		...
		*out = make([]registry.RegistryCache, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_RegistryCache_To_registry_RegistryCache(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_registry_RegistryConfig_To_v1alpha2_RegistryConfig(in *registry.RegistryConfig, out *RegistryConfig, s conversion.Scope) error {
	if in.Caches != nil {
		...
		*out = make([]RegistryCache, len(*in))
		for i := range *in {
			if err := Convert_registry_RegistryCache_To_v1alpha2_RegistryCache(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
