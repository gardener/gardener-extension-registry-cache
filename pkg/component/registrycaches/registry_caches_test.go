...
`
			...
			statefulSetYAMLFor = func(name, upstream, size, configSecretName, tlsSecretName, checksum string, storageClassName *string, additionalEnvs []corev1.EnvVar) string {
		...
		Context("when VPA is enabled", func() {
			It("should successfully deploy the resources", func() {
				...
				expectedManifests := []string{
					...
					statefulSetYAMLFor("registry-docker-io", "docker.io", "10Gi", dockerConfigSecretName, dockerTLSSecretName, utils.ComputeChecksum(dockerTLSSecretData), nil, nil),
					...
					statefulSetYAMLFor("registry-europe-docker-pkg-dev", "europe-docker.pkg.dev", "20Gi", arConfigSecretName, arTLSSecretName, utils.ComputeChecksum(arTLSSecretData), ptr.To("premium"), nil),
		...
		Context("when a proxy is set", func() {
			...
			It("should successfully deploy the resources", func() {
				...
				expectedManifests := []string{
					configSecretYAMLFor(dockerConfigSecretName, "registry-docker-io", "docker.io", configYAMLFor("https://registry-1.docker.io", "336h0m0s", "", "")),
					secretYAMLFor(dockerSecret.Data["ca.crt"], dockerSecret.Data["ca.key"], "registry-docker-io", "docker.io", dockerTLSSecretName),
					statefulSetYAMLFor("registry-docker-io", "docker.io", "10Gi", dockerConfigSecretName, dockerTLSSecretName, utils.ComputeChecksum(dockerTLSSecretData), nil, additionalEnvs),
					vpaYAMLFor("registry-docker-io"),
					configSecretYAMLFor(arConfigSecretName, "registry-europe-docker-pkg-dev", "europe-docker.pkg.dev", configYAMLFor("https://europe-docker.pkg.dev", "0s", "", "")),
					secretYAMLFor(arSecret.Data["ca.crt"], arSecret.Data["ca.key"], "registry-europe-docker-pkg-dev", "europe-docker.pkg.dev", arTLSSecretName),
					statefulSetYAMLFor("registry-europe-docker-pkg-dev", "europe-docker.pkg.dev", "20Gi", arConfigSecretName, arTLSSecretName, utils.ComputeChecksum(arTLSSecretData), ptr.To("premium"), additionalEnvs),
					vpaYAMLFor("registry-europe-docker-pkg-dev"),
				}
				Expect(manifests).To(ConsistOf(expectedManifests))
			})
